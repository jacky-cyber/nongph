...
public class FieldManager {
    ...
    public Field getField(Class<?> clazz, String fieldName) throws IllegalStateException {
        PersistenceOperationExecutor persistenceManager = getPersistenceManager();
    ...
    protected PersistenceOperationExecutor getPersistenceManager() {
        PersistenceOperationExecutor persistenceManager;
        try {
            persistenceManager = PersistenceOperationExecutorFactory.getPersistenceManager();
        } catch (IllegalStateException e) {
            persistenceManager = PersistenceOperationExecutorFactory.getPersistenceManager(TargetModeType.SANDBOX);
        }
