...
public class AdornedTargetListPersistenceModule extends BasicPersistenceModule {
    ...
    public boolean isCompatible(OperationScope operationType) {
        return OperationScope.ADORNEDTARGETLIST.equals(operationType);
    }
    ...
    public List<FilterMapping> getBasicFilterMappings(PersistenceAssociation persistencePerspective,
    ...
    public List<FilterMapping> getAdornedTargetFilterMappings(PersistenceAssociation persistencePerspective,
                    CriteriaTransferObject cto, Map<String, FieldMetadata> mergedProperties,
    ...
    protected Serializable createPopulatedAdornedTargetInstance(AdornedTargetList adornedTargetList, Entity entity) throws InstantiationException, IllegalAccessException, ClassNotFoundException, NumberFormatException, InvocationTargetException, NoSuchMethodException, FieldNotAvailableException {
        ...
        Object test1PersistedObject = persistenceOperationExecutor.getDynamicEntityDao().retrieve(test1.getClass(), Long.valueOf(entity.findProperty(linkedPath).getValue()));
        ...
        if (String.class.isAssignableFrom(type)) {
            test2PersistedObject = persistenceOperationExecutor.getDynamicEntityDao().retrieve(test2.getClass(), entity.findProperty(targetPath).getValue());
        } else {
            test2PersistedObject = persistenceOperationExecutor.getDynamicEntityDao().retrieve(test2.getClass(), Long.valueOf(entity.findProperty(targetPath).getValue()));
        }
    ...
    public void updateMergedProperties(PersistencePackage persistencePackage, Map<MergedPropertyType, Map<String, FieldMetadata>> allMergedProperties) throws ServiceException {
        ...
        try {
            ...
            AdornedTargetList adornedTargetList = (AdornedTargetList) persistencePerspective.getPersistenceAssociationItems().get(PersistenceAssociationItemType.ADORNEDTARGETLIST);
            if (adornedTargetList != null) {
                Class<?>[] entities = persistenceOperationExecutor.getPolymorphicEntities(adornedTargetList.getAdornedTargetEntityClassname());
                Map<String, FieldMetadata> joinMergedProperties = persistenceOperationExecutor.getDynamicEntityDao().getMergedProperties(
    ...
    public Entity add(PersistencePackage persistencePackage) throws ServiceException {
        ...
        try {
            ...
            Map<String, FieldMetadata> mergedPropertiesTarget = persistenceOperationExecutor.getDynamicEntityDao().getMergedProperties(
            ...
            Class<?>[] entities2 = persistenceOperationExecutor.getPolymorphicEntities(adornedTargetList.getAdornedTargetEntityClassname());
            ...
            if (recordsInserted.size() > 0) {
                ...
                persistenceOperationExecutor.getDynamicEntityDao().clear();
    ...
    public Entity update(PersistencePackage persistencePackage) throws ServiceException {
        ...
        try {
            ...
            myRecord = createPopulatedInstance(myRecord, entity, mergedProperties, false);
            myRecord = persistenceOperationExecutor.getDynamicEntityDao().merge(myRecord);
    ...
    public void remove(PersistencePackage persistencePackage) throws ServiceException {
        ...
        try {
            ...
            persistenceOperationExecutor.getDynamicEntityDao().remove(recordsInserted.get(0));
        } catch (Exception e) {
    ...
    public class AdornedTargetRetrieval {
        ...
        private PersistenceAssociation persistencePerspective;
        ...
        public AdornedTargetRetrieval(PersistencePackage persistencePackage, AdornedTargetList adornedTargetList, CriteriaTransferObject cto) {
            ...
            this.persistencePerspective = persistencePackage.getPersistenceAssociation();
        ...
        private void invokeInternal() throws ClassNotFoundException {
            ...
            Class<?>[] entities = persistenceOperationExecutor.getPolymorphicEntities(adornedTargetList
                    .getAdornedTargetEntityClassname());
            mergedProperties = persistenceOperationExecutor.getDynamicEntityDao().getMergedProperties(
                    adornedTargetList.getAdornedTargetEntityClassname(),
                    entities,
                    null,
                    new String[]{},
            ...
            String ceilingEntityFullyQualifiedClassname = persistencePackage.getRootEntityClassname();
            Class<?>[] entities2 = persistenceOperationExecutor.getPolymorphicEntities(ceilingEntityFullyQualifiedClassname);
            Map<String, FieldMetadata> mergedPropertiesTarget = persistenceOperationExecutor.getDynamicEntityDao()
                    .getMergedProperties(
                    ceilingEntityFullyQualifiedClassname,
                    entities2,
                    null,
