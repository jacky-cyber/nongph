package cn.globalph.openadmin.dto.override;
...
public class FieldMetadataOverride {
    ...
    private OperationScope addType;
    private OperationScope removeType;
    private OperationScope updateType;
    private OperationScope fetchType;
    private OperationScope inspectType;
