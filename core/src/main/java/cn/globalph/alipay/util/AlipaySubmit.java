package cn.globalph.alipay.util;
...
import cn.globalph.alipay.sign.MD5;
...
public class AlipaySubmit {
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
		...
		sbHtml.append("<!--[if lt IE 7]> <html class=\"no-js lt-ie9 lt-ie8 lt-ie7\" lang=\"en\"> <![endif]-->");
		sbHtml.append("<!--[if IE 7]> <html class=\"no-js lt-ie9 lt-ie8\" lang=\"en\"> <![endif]-->");
		sbHtml.append("<!--[if IE 8]> <html class=\"no-js lt-ie9\" lang=\"en\"> <![endif]-->");
		sbHtml.append("<!--[if gt IE 8]><!--> <html class=\"no-js\" lang=\"en\"> <!--<![endif]-->");
		sbHtml.append("<head>");
...
//        sbHtml.append("<input type=\"submit\" value=\"" + strButtonName + "\" style=\"display:none;\"></form>");
        ...
        sbHtml.append("<input type=\"submit\" value=\"Please Click Here To Complete Checkout\"/>");
        sbHtml.append("</body>");
	    sbHtml.append("</html>");
