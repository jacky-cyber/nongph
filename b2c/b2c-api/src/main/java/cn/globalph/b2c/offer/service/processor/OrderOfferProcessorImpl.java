...
import cn.globalph.b2c.offer.service.OfferServiceUtilities;
...
import cn.globalph.b2c.offer.service.discount.domain.PromotableOrderAdjustment;
...
import cn.globalph.b2c.offer.service.discount.domain.PromotableOrderItemPriceDetailAdjustment;
...
public class OrderOfferProcessorImpl extends AbstractBaseProcessor implements OrderOfferProcessor {
    ...
    public void synchronizeAdjustmentsAndPrices(PromotableOrder promotableOrder) {
        ...
        if (extensionManager != null) {
            extensionManager.getHandlerProxy().synchronizeAdjustmentsAndPrices(promotableOrder);
        }
