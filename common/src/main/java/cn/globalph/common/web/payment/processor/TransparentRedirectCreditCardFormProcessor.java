 ...
 * </code></pre>
 *
 * <p>NOTE: please see {@link cn.globalph.common.web.payment.expression.PaymentGatewayFieldVariableExpression}
 * to modify the input "name" fields for a particular gateway</p>
 *
 * @see {@link cn.globalph.common.web.payment.expression.PaymentGatewayFieldVariableExpression}
...
public class TransparentRedirectCreditCardFormProcessor extends AbstractElementProcessor {
    ...
    protected ProcessorResult processElement(Arguments arguments, Element element) {
        ...
        try {
            extensionManager.getHandlerProxy().createTransparentRedirectForm(formParameters,
        ...
        extensionManager.getHandlerProxy().setFormActionKey(formActionKey);
        extensionManager.getHandlerProxy().setFormHiddenParamsKey(formHiddenParamsKey);
