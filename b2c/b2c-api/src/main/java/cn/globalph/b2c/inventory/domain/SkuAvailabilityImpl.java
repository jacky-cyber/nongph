package cn.globalph.b2c.inventory.domain;

import cn.globalph.b2c.inventory.service.type.AvailabilityStatusType;
...
@Table(name = "NPH_SKU_AVAILABILITY")
...
public class SkuAvailabilityImpl implements SkuAvailability {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="cn.globalph.b2c.inventory.domain.SkuAvailabilityImpl")
        }
    )
    ...
    @AdminPresentation(friendlyName = "SkuAvailabilityImpl_Availability_Status", group = "SkuAvailabilityImpl_Description", fieldType= SupportedFieldType.BROADLEAF_ENUMERATION, broadleafEnumeration="cn.globalph.b2c.inventory.service.type.AvailabilityStatusType")
