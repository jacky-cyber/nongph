...
Ecp.CurrencyStore.prototype.handleWidgetConfig=function(handler){
	handler(this);
}

Ecp.CurrencyStore.prototype.setEventConfig=function(obj){
	this.dataStore.setEventConfig(obj);
}

Ecp.CurrencyStore.prototype.customization=function(obj){
	this.customConfig=obj;
}

Ecp.CurrencyStore.prototype.load=function(baseParams){
...
Ecp.CurrencyStore.prototype.reload=function(){
	this.dataStore.store.reload();
}

Ecp.CurrencyStore.prototype.render=function(){
...
Ecp.CurrencyGridWidget=function(){
	this.dataStore=new Ecp.CurrencyStore();
...
Ecp.CurrencyGridWidget.prototype.show=function(){
	this.dataStore.load({start:0, limit:PAGE_SIZE});
}
