...
import cn.globalph.common.presentation.client.UnspecifiedBooleanType;
import cn.globalph.common.presentation.override.AdminPresentationMapOverride;
...
public class MapFieldMetadataProvider extends AdvancedCollectionFieldMetadataProvider {
    ...
    public FieldProviderResponse addMetadataFromFieldType(AddMetadataFromFieldTypeRequest req, Map<String, FieldMetadata> metadata) {
        ...
        metadata.put(req.getRequestedPropertyName(), req.getPresentationAttribute());
        return FieldProviderResponse.HANDLED;
    }
    ...
    protected void buildMapMetadata(Class<?> parentClass, Class<?> targetClass, Map<String, FieldMetadata> attributes,
        ...
        cn.globalph.openadmin.dto.PersistenceOperationType dtoOperationTypes = new cn.globalph.openadmin.dto.PersistenceOperationType(OperationScope.MAP, OperationScope.MAP, OperationScope.MAP, OperationScope.MAP, OperationScope.MAP);
        ...
        if (serverMetadata != null) {
            keyClassName = ((MapStructure) metadata.getPersistenceAssociation().getPersistenceAssociationItems().get
                    (PersistenceAssociationItemType.MAPSTRUCTURE)).getKeyClassName();
        }
        ...
        if (serverMetadata != null) {
            keyPropertyFriendlyName = ((MapStructure) serverMetadata.getPersistenceAssociation().getPersistenceAssociationItems().get(PersistenceAssociationItemType.MAPSTRUCTURE)).getKeyPropertyFriendlyName();
        }
        ...
        if (serverMetadata != null) {
            deleteEntityUponRemove = ((MapStructure) serverMetadata.getPersistenceAssociation().getPersistenceAssociationItems().get(PersistenceAssociationItemType.MAPSTRUCTURE)).getDeleteValueEntity();
        }
        ...
        if (serverMetadata != null) {
            MapStructure structure = (MapStructure) serverMetadata.getPersistenceAssociation().getPersistenceAssociationItems().get(PersistenceAssociationItemType.MAPSTRUCTURE);
        ...
        if (serverMetadata != null) {
            ...
            if (metadata.isSimpleValue()) {
                mapStructure = (SimpleValueMapStructure) persistencePerspective.getPersistenceAssociationItems().get(PersistenceAssociationItemType.MAPSTRUCTURE);
                ...
                mapStructure = (MapStructure) persistencePerspective.getPersistenceAssociationItems().get(PersistenceAssociationItemType.MAPSTRUCTURE);
                mapStructure.setKeyClassName(keyClassName);
                mapStructure.setKeyPropertyName(keyPropertyName);
                mapStructure.setKeyPropertyFriendlyName(keyPropertyFriendlyName);
                mapStructure.setValueClassName(metadata.getValueClassName());
            ...
            persistencePerspective.addPersistenceAssociationItem(PersistenceAssociationItemType.FOREIGNKEY, foreignKey);
            if (metadata.isSimpleValue()) {
            ...
            persistencePerspective.addPersistenceAssociationItem(PersistenceAssociationItemType.MAPSTRUCTURE, mapStructure);
        }
