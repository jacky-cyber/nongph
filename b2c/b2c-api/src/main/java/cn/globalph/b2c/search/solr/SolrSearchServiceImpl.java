...
import cn.globalph.b2c.search.domain.RequiredFacet;
...
public class SolrSearchServiceImpl implements SearchService, DisposableBean {
    ...
    @Override
    public SkuSearchResult findExplicitSkusByCategory(Category category, SkuSearchCriteria searchCriteria)
     ...
     */
    protected SkuSearchResult findProducts(String qualifiedSolrQuery, List<SearchFacetDTO> facets,
            SkuSearchCriteria searchCriteria, String defaultSort) throws ServiceException {
     ...
     */
    protected SkuSearchResult findProducts(String qualifiedSolrQuery, List<SearchFacetDTO> facets,
            SkuSearchCriteria searchCriteria, String defaultSort, String... filterQueries) throws ServiceException {
        ...
        extensionManager.getHandlerProxy().modifySolrQuery(solrQuery, qualifiedSolrQuery, facets,
     ...
     * {@link SolrSearchServiceExtensionHandler#modifySolrQuery(SolrQuery, String, List, SkuSearchCriteria, String)}
     * 
     * @param query
     * @param qualifiedSolrQuery
     * @param facets
     ...
     * @param searchCriteria
     */
    protected void attachSortClause(SolrQuery query, SkuSearchCriteria searchCriteria, String defaultSort) {
    ...
    protected void attachActiveFacetFilters(SolrQuery query, Map<String, SearchFacetDTO> namedFacetMap,
            SkuSearchCriteria searchCriteria) {
    ...
    protected void attachFacets(SolrQuery query, Map<String, SearchFacetDTO> namedFacetMap) {
        ...
        for (Entry<String, SearchFacetDTO> entry : namedFacetMap.entrySet()) {
            ...
            if (extensionManager != null) {
                extensionManager.getHandlerProxy().filterSearchFacetRanges(dto, facetRanges);
            }
     ...
     * @param searchCriteria
     */
    public void setPagingAttributes(SkuSearchResult result, int numResults, SkuSearchCriteria searchCriteria) {
    ...
    protected List<Sku> getSkus(List<SolrDocument> responseDocuments) {
        ...
        for (SolrDocument doc : responseDocuments) {
            skuIds.add((Long) doc.getFieldValue(shs.getProductIdFieldName()));
        }
    ...
    protected List<SearchFacetDTO> buildSearchFacetDTOs(List<SearchFacet> searchFacets) {
        ...
        Map<String, String[]> requestParameters = WebRequestContext.getRequestParameterMap();
    ...
    protected Map<String, SearchFacetDTO> getNamedFacetMap(List<SearchFacetDTO> facets,
            final SkuSearchCriteria searchCriteria) {
     ...
     */
    protected String getSolrFieldKey(Field field, SkuSearchCriteria searchCriteria) {
     ...
     */
    protected Map<String, String> getSolrFieldKeyMap(SkuSearchCriteria searchCriteria) {
        List<Field> fields = fieldDao.readAllProductFields();
