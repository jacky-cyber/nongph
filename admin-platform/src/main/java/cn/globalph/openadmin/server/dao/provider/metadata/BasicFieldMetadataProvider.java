...
import cn.globalph.common.enumeration.domain.DataDrivenEnumerationValueImpl;
...
import cn.globalph.common.presentation.override.AdminPresentationDataDrivenEnumerationOverride;
...
import cn.globalph.common.presentation.override.AdminPresentationToOneLookupOverride;
...
public class BasicFieldMetadataProvider extends FieldMetadataProviderAdapter {
    ...
    public FieldProviderResponse addMetadata(AddMetadataRequest addMetadataRequest, Map<String, FieldMetadata> metadata) {
        ...
        AdminPresentation annot = addMetadataRequest.getRequestedField().getAnnotation(AdminPresentation.class);
        AdminPresentationToOneLookup toOneLookupAnn = addMetadataRequest.getRequestedField().getAnnotation(AdminPresentationToOneLookup.class);
        AdminPresentationDataDrivenEnumeration dataDEAnn = addMetadataRequest.getRequestedField().getAnnotation(AdminPresentationDataDrivenEnumeration.class);
        FieldMetadataOverride override = constructBasicMetadataOverride(annot, toOneLookupAnn, dataDEAnn);
        buildBasicMetadata( addMetadataRequest.getParentClass(), addMetadataRequest.getTargetClass(), 
