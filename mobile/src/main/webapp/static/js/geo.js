...
function preselect(province, city, district, community) {
    var provinceIndex;
    ...
    if (provinceIndex < provinces.length) {
        document.getElementById(s[0]).selectedIndex = provinceIndex + 1;
        change(1);
    }

    var cityIndex;
    var cities = dsy.Items["0_" + provinceIndex];
    ...
    if (cityIndex < cities.length) {
        document.getElementById(s[1]).selectedIndex = cityIndex + 1;
        change(2);
    }

    var districtIndex;
    var districts = dsy.Items["0_" + provinceIndex + "_" + cityIndex];
    ...
    if (districtIndex < districts.length) {
        document.getElementById(s[2]).selectedIndex = districtIndex + 1;
        change(3);
    }

    var communityIndex;
    var communities = dsy.Items["0_" + provinceIndex + "_" + cityIndex + "_" + districtIndex];
    var communityCount = communities.length;
    for (var i = 0; i < communityCount; i++) {
        if (community == communities[i]) {
            communityIndex = i;
            break;
        }
    }
    if (communityIndex < communities.length) {
        document.getElementById(s[3]).selectedIndex = communityIndex + 1;
        change(4);
    }
...
//dsy.add("0_10_12", ["姑苏区", "相城区", "吴中区", "虎丘区", "工业园区", "吴江区", "太仓市", "昆山市", "张家港市", "常熟市"]);
...
dsy.add("0", ["江苏省"]);
dsy.add("0_0", ["苏州市"]);
dsy.add("0_0_0", ["工业园区", "吴中区", "姑苏区", "相城区", "虎丘区"]);
dsy.add("0_0_0_0", ["半岛花园", "中海花园", "熙岸花园", "星湖花园", "海悦花园一区", "海悦花园二区", "海悦花园三区", "海悦花园四区", "海悦花园五区", "海悦花园六区", "海悦花园七区", "独墅岛花园", "海悦馨园", "时代尚城", "双湖湾花园"]);
dsy.add("0_0_0_1", []);
dsy.add("0_0_0_2", ["凤凰胥岸花园"]);
dsy.add("0_0_0_3", []);
dsy.add("0_0_0_4", ["玉山雅苑", "玉景湾花园"]);

var s = ["province", "city", "district", "community"];
var opt0 = ["请选择省份", "请选择城市", "请选择区/县", "请选择小区(选填)"];
