...
/**
 * Implementation of EmailInfo that will not send an Email. The out of box configuration
 * does not send emails but does have hooks to send emails for use cases like
