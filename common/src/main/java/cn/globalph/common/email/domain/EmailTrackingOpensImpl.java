...
@Entity
@Table(name = "NPH_EMAIL_TRACKING_OPENS")
public class EmailTrackingOpensImpl implements EmailTrackingOpens {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="cn.globalph.common.email.domain.EmailTrackingOpensImpl")
        }
    )
    @Column(name = "OPEN_ID")
    protected Long id;
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTrackingOpens#getId()
     */
    @Override
    public Long getId() {
        return id;
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTrackingOpens#setId(java.lang.Long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTrackingOpens#getDateOpened()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTrackingOpens#setDateOpened(java.util.Date)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTrackingOpens#getUserAgent()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTrackingOpens#setUserAgent(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTrackingOpens#getEmailTracking()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTrackingOpens#setEmailTracking(cn.globalph.common.email.domain.EmailTrackingImpl)
     */
    @Override
