...
public class ProviderApplyCondition extends CouponApplyCondition<String> {
    public ProviderApplyCondition(String value) {
        super(CouponAttributeNameType.PROVIDER.getType(), value);
    }
