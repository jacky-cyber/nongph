...
public class PaymentType implements Serializable, EnumerationType {
    ...
    public static final PaymentType COD = new PaymentType("COD", "货到付款");
    public static final PaymentType WECHAT = new PaymentType("WECHAT", "微信支付");
    public static final PaymentType ALIPAY_WAP_DIRECT = new PaymentType("ALIPAY_WAP_DIRECT", "支付宝手机网站即时支付");
    public static final PaymentType ALIPAYESCOW = new PaymentType("ALIPAYESCOW","支付宝担保交易");
    /**
