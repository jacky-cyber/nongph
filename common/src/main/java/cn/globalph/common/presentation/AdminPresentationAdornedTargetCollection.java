...
public @interface AdminPresentationAdornedTargetCollection {
     ...
     */
    AdminPresentationOperationTypes operationTypes() default @AdminPresentationOperationTypes(addType = OperationScope.ADORNEDTARGETLIST, fetchType = OperationScope.ADORNEDTARGETLIST, inspectType = OperationScope.BASIC, removeType = OperationScope.ADORNEDTARGETLIST, updateType = OperationScope.ADORNEDTARGETLIST);
