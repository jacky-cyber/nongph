...
public class EntityForm {
    ...
    public void addField(Field field, String groupName, Integer groupOrder, String tabName, Integer tabOrder) {
        ...
        if (context != null && context.getMessageSource() != null) {
            groupName = context.getMessageSource().getMessage(groupName, null, groupName, Locale.CHINA);
            tabName = context.getMessageSource().getMessage(tabName, null, tabName, Locale.CHINA);
        }
    ...
    public String getTranslationCeilingEntity() {
        return translationCeilingEntity == null ? rootEntityClassname : translationCeilingEntity;
    }
