 ...
 */
public class PaymentGatewayType implements Serializable, EnumerationType {
    ...
    public static final PaymentGatewayType WECHAT = new PaymentGatewayType("Wechat", "Wechat Payment");
    public static final PaymentGatewayType ALIPAY = new PaymentGatewayType("Alipay", "Alipay Payment");
