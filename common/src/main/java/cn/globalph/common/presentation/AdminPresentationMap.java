...
public @interface AdminPresentationMap {
     ...
     */
    AdminPresentationOperationTypes operationTypes() default @AdminPresentationOperationTypes(addType = OperationScope.MAP, fetchType = OperationScope.MAP, inspectType = OperationScope.MAP, removeType = OperationScope.MAP, updateType = OperationScope.MAP);
