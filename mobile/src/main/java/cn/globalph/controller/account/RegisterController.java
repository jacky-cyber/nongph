...
public class RegisterController extends cn.global.passport.web.controller.BasicRegisterController {
    ...
    public String registerByPhone(HttpServletRequest request, HttpServletResponse response, Model model,
            @ModelAttribute("registrationForm") RegisterCustomerForm registerCustomerForm) {
        return super.registerByPhone(registerCustomerForm, request, response, model);
    }
    
    @RequestMapping(value="byPhone",method=RequestMethod.POST)
    public String processRegisterByPhone(HttpServletRequest request, HttpServletResponse response, Model model,
            @ModelAttribute("registrationForm") RegisterCustomerForm registerCustomerForm, BindingResult errors) throws ServiceException, PricingException {
        return super.processRegisterByPhone(registerCustomerForm, errors, request, response, model);
    }
}
