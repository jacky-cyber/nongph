...
public class EmailTrackingImpl implements EmailTracking {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="cn.globalph.common.email.domain.EmailTrackingImpl")
        }
    )
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTracking#getId()
     */
    @Override
    public Long getId() {
        return id;
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTracking#setId(java.lang.Long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTracking#getEmailAddress()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTracking#setEmailAddress(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTracking#getDateSent()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTracking#setDateSent(java.util.Date)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTracking#getType()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.globalph.common.email.domain.EmailTracking#setType(java.lang.String)
     */
    @Override
