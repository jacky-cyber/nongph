 ...
 */
public class SaleCountDecrementActivity extends BaseActivity<ProcessContext<CheckoutSeed>> {

    protected static final Log LOG = LogFactory.getLog(SaleCountDecrementActivity.class);
    ...
    public ProcessContext<CheckoutSeed> execute(ProcessContext<CheckoutSeed> context) throws Exception {
        ...
        for (OrderItem orderItem : orderItems) {
            ...
            sku.setSaleCount(sku.getSaleCount() - quantity);
            skuDao.save(sku);
        }
        return context;
    }
