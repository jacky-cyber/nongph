...
public class BasicFieldMetadata extends FieldMetadata {
    ...
    protected String foreignKeyProperty; //外健属性名
    protected String foreignKeyClass;    //外健属性对应的类   
    protected String foreignKeyDisplayValueProperty;//外健显示属性
    protected Boolean foreignKeyCollection;
    protected MergedPropertyType mergedPropertyType;
    protected String[][] enumerationValues;//枚具值
    ...
    protected LookupType lookupType; //查找类型，有弹窗选择、下拉框选择。当为外健时使用
    protected String lookupDisplayProperty; //查找显示属性
