...
import cn.globalph.common.sandbox.dao.SandBoxDao;
...
import cn.globalph.common.time.FixedTimeSource;
        ...
        if (!sandBoxPreviewEnabled) {
            ...
            if (sandboxId != null) {
                if (previousSandBoxId != null && !previousSandBoxId.equals(sandboxId)) {
                    request.setAttribute(WebRequestContextSupportRequestProcessor.REPROCESS_PARAM_NAME, true, WebRequest.SCOPE_REQUEST);
                }
