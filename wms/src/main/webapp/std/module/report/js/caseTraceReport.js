...
function caseTraceReportLayout(){
	...
	caseTraceReportToolBar.setWidgetEvent({
		queryCaseReport:showQueryCaseTraceReportWin
	});
	caseTraceReportToolBar.customization(toolBarCusObj);
	
	// initialize grid
	var caseTraceReportGrid=new Ecp.CaseReportGridWidget(TXT.reportTrace, 'genTraceReport');
...
Ecp.onReady(caseTraceReportLayout);