...
public class SearchFilterItemTag extends SimpleTagSupport {
    ...
    private void doSliderRange(JspWriter out)  throws JspException, IOException {
        ...
        out.println("Range:");
        out.println("<input type=\"text\" id=\"min-" + propertyCss + "\" name='min-" + property + "' value='"+Money.currency.getSymbol()+min.getAmount().toPlainString()+"'/> - ");
        out.println("<input type=\"text\" id=\"max-" + propertyCss + "\" name='max-" + property + "' value='"+Money.currency.getSymbol()+max.getAmount().toPlainString()+"'/> <br/>");
        ...
        out.println("        <script type=\"text/javascript\">\r\n" +
                ...
                "                    $(\"#min-" + propertyCss + "\").val('" + Money.currency.getSymbol() + "' + ui.values[0] );\r\n" +
                "                    $(\"#max-" + propertyCss + "\").val('" + Money.currency.getSymbol() + "' + ui.values[1]);\r\n" +
                "                }\r\n" +
                "            });\r\n" +
                "        });\r\n" +
