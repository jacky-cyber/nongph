...
public @interface AdminPresentationCollection {
     ...
     */
    AdminPresentationOperationTypes operationTypes() default @AdminPresentationOperationTypes(addType = OperationScope.BASIC, fetchType = OperationScope.BASIC, inspectType = OperationScope.BASIC, removeType = OperationScope.BASIC, updateType = OperationScope.BASIC);
