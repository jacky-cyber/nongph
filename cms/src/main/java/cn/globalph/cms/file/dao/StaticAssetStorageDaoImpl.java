...
import cn.globalph.cms.file.domain.StaticAssetStorageImpl;
...
public class StaticAssetStorageDaoImpl implements StaticAssetStorageDao {
    ...
    public StaticAssetStorage create() {
        return (StaticAssetStorage) entityConfiguration.createEntityInstance("cn.globalph.cms.file.domain.StaticAssetStorage");
    }
