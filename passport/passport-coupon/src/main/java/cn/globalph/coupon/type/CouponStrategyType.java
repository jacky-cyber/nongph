...
public class CouponStrategyType implements Serializable, EnumerationType {
    ...
    private static final Map<String, CouponStrategyType> TYPES = new LinkedHashMap<String, CouponStrategyType>();

    public static final CouponStrategyType CASH_COUPON_STRATEGY  = new CouponStrategyType("phCashCouponStrategy", "现金抵用");
    public static final CouponStrategyType DISCOUNT_COUPON_STRATEGY  = new CouponStrategyType("CREATE", "折扣");
