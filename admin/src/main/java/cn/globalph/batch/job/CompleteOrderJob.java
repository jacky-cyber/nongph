...
@Component("CompleteOrderJob")
@JobId("CompleteOrderJob")
public class CompleteOrderJob extends SingletonJob {
    ...
    protected void doExecute(JobContext jobContext) throws Exception {
     	 List<Order> orders = orderService.findCompleteOverdueOrders();
